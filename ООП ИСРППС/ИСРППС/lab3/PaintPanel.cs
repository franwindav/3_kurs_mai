...
namespace lab3
{
    ...
    {
        private static readonly Pen instance = new Pen(Color.Black, 1.5F);
    ...
    class WebDrawer : Mode
    {
        ...
        private void Resize()
        {
            ...
            positions = new Point[] {
                new Point(0, 0), new Point(0, end.Y),
                new Point(end.X, 0), new Point(end.X, end.Y),
        ...
        public void Draw(PaintEventArgs e)
        {
            ...
            foreach (Point p in positions)
                e.Graphics.DrawLine(pen, p, current);
        }
